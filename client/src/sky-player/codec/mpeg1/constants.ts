...
export const DEFAULT_INTRA_QUANT_MATRIX = new Uint8Array([
...
export const DEFAULT_NON_INTRA_QUANT_MATRIX = new Uint8Array([
...
export const PREMULTIPLIER_MATRIX = new Uint8Array([
  32, 44, 42, 38, 32, 25, 17, 9, 44, 62, 58, 52, 44, 35, 24, 12, 42, 58, 55, 49,
  42, 33, 23, 12, 38, 52, 49, 44, 38, 30, 20, 10, 32, 44, 42, 38, 32, 25, 17, 9,
  25, 35, 33, 30, 25, 20, 14, 7, 17, 24, 23, 20, 17, 14, 9, 5, 9, 12, 12, 10, 9,
  7, 5, 2,
]);
...
export const MACROBLOCK_ADDRESS_INCREMENT = new Int16Array([
  1 * 3,
  2 * 3,
  0, //   0
  3 * 3,
...
export const MACROBLOCK_TYPE_INTRA = new Int8Array([
  1 * 3,
  2 * 3,
  0, //   0
  -1,
...
export const MACROBLOCK_TYPE_PREDICTIVE = new Int8Array([
  1 * 3,
  2 * 3,
  0, //  0
  3 * 3,
...
export const MACROBLOCK_TYPE_B = new Int8Array([
  1 * 3,
  2 * 3,
  0, //  0
  3 * 3,
...
export const CODE_BLOCK_PATTERN = new Int16Array([
  2 * 3,
  1 * 3,
  0, //   0
  3 * 3,
...
export const MOTION = new Int16Array([
  1 * 3,
  2 * 3,
  0, //   0
  4 * 3,
...
export const DCT_DC_SIZE_LUMINANCE = new Int8Array([
  2 * 3,
  1 * 3,
  0, //   0
  6 * 3,
...
export const DCT_DC_SIZE_CHROMINANCE = new Int8Array([
  2 * 3,
  1 * 3,
  0, //   0
  4 * 3,
...
export const DCT_COEFF = new Int32Array([
  1 * 3,
  2 * 3,
  0, //   0
  4 * 3,
